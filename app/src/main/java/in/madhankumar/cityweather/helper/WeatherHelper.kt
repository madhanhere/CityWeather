package `in`.madhankumar.cityweather.helper
...
class Forecast(val code: String, val date: String, val day: String, val high: String,
               val low: String, val text: String)
...
class WeatherRetriever {
    ...
    fun getForecast(callBack: Callback<Weather>, searchTerm: String) {
        ...
        val call = service.getForecast("select * from weather.forecast where woeid in (select woeid from geo.places(1) where text=\"${city}\")")
